...
extern void set_cursor(uint32_t bx);
// 系统调用中断处理函数
extern uint32_t syscall_handler();


// 0x21 已支持中断数
#define IDT_DESC_CNT    0x81            //系统调用使用0x80
...
static void idt_desc_init(){
    ...
    // 单独安装系统调用0x80号对应的中断门描述符，该描述符为能实现用户访问，其DPL为3
...
static void pic_init(){
    ...
    // 硬盘驱动
    // 主片打开的中断有 IRQ0时钟中断 IRQ1 键盘中断 IRQ2 级联从片； 7-0 1111 1000 
    // 从片打开IRQ6 IRQ7 ATA0、ATA1 7-0 0011 1111，我们的两块硬盘均在ATA0，因此只打开ATA0也可
